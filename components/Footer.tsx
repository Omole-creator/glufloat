    ...
    <footer className="border-t border-line bg-mist">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="text-sm">
            <p className="font-semibold text-ink">The serious part</p>
            <ul className="mt-3 space-y-2 text-ink-soft">
        ...
        <div className="mt-10 border-t border-line pt-6">
          <p className="text-xs leading-relaxed text-ink-soft">
            ...
            diabetes. It is not medical advice. It does not diagnose, treat,
            cure, or reverse any condition. Always talk to your doctor before
            changing your diet or medicine.
          </p>
          <p className="mt-3 text-xs text-ink-soft">
            © 2026 Glufloat. Lagos, Nigeria.
          </p>
        </div>
      </div>
    </footer>
