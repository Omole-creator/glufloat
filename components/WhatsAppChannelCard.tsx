...
export default function WhatsAppChannelCard() {
  return (
    <a
      ...
      className="flex items-center justify-center gap-2.5 rounded-2xl bg-[#25D366] px-5 py-4 text-center font-bold text-white shadow-sm transition-transform hover:scale-[1.01]"
    >
