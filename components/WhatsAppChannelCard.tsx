...
/**
 * A link asking people to join the Glufloat WhatsApp channel. This audience
 * lives on WhatsApp, so a channel is where tips and new foods reach them for
 * free. Plain link, no API, no cost.
 *
 * It is a SLIM one-line banner on purpose. As a full card it competed with the
 * product itself, and the community is helpful, not the reason anyone opened the
 * app.
 */
export default function WhatsAppChannelCard() {
  return (
    <a
      ...
      className="group flex items-center gap-3 rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-ink shadow-[0_4px_20px_-12px_rgba(12,42,71,0.2)] ring-1 ring-ink/[0.04] transition-colors hover:bg-mist/60"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
      ...
      <span className="flex-1">Join our diabetes community</span>
      <span
        aria-hidden
